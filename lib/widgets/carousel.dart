...
class Carousel extends StatefulWidget {
  ...
  // The base size of the dots. Default is 10.0
  final double dotSize;

  // The increase in the size of the selected dot. Default is 1.0
  final double dotIncreaseSize;

  // The distance between the center of each dot. Default is 20.0
  ...
  //Duration of the Auto play slider by seconds.
  ...
  Carousel({
    ...
    this.dotIncreaseSize = 1.0,
    this.dotColor = const Color(0xFF87919E),
    this.dotSelectedColor = const Color(0xFF87919E),
    this.dotBgColor = Colors.transparent,
    this.showIndicator = true,
    this.indicatorBgPadding = 5.0,
    this.boxFit = BoxFit.cover,
    this.borderRadius = false,
    this.radius,
    this.moveIndicatorFromBottom = 16.0,
...
class DotsIndicator extends AnimatedWidget {
  ...
  Widget _buildDot(int index) {
    ...
    var fixedIndex = index.toStringAsFixed(0);
    var fixedPage = (controller.page ?? controller.initialPage).toStringAsFixed(0);

    return Container(
      width: dotSpacing,
      child: Center(
        child: Material(
          color: fixedIndex == fixedPage ? selectedColor : color,
